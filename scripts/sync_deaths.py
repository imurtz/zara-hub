...
def main():
    ...
    # يبقى 5 دائماً بطلب صريح من المستخدم (حتى بعد إلغاء الجدولة الدورية) — يفحص فقط أحدث 5 أخبار
    # لاكتشاف المحذوف/الناقص، ويعيد قراءة أحدث 5 لالتقاط الاستكمال. هذا لا يؤثر على اكتشاف "الخبر
    # الجديد" أصلاً، فذاك يفحص القائمة كاملة دائماً بغض النظر عن هذا الرقم
    ap.add_argument("--window", type=int, default=5, help="عدد أحدث الأخبار المفحوصة كل تشغيل لاكتشاف المحذوف/الناقص")
