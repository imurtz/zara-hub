...
3. لا يتجاوز النص الكامل 210 حرفاً فعلياً (بالعدّ الحرفي الدقيق، بما فيها المسافات وعلامات الترقيم) — هذا حد أقصى إلزامي.
...
مثال توضيحي (مذكر) على الشكل والطول المطلوبين بالضبط:
...
export default {
  async fetch(request, env) {
    ...
    return json({ suggestion: trimToLimit(text, 210) }, 200, headers);
  }
};
...
// شبكة أمان فقط — إن تجاوز النموذج الحد بهامش كبير، نقصّه عند آخر مسافة قبل الحد بدل عرض نص طويل جداً
